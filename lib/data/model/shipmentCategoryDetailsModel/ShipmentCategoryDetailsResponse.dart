class ShipmentCategoryDetailsResponse {
  bool? success;
  Null message;
  Data? data;

  ShipmentCategoryDetailsResponse({this.success, this.message, this.data});

  ShipmentCategoryDetailsResponse.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data({this.statues, this.orders, this.currentPage,this.lastPage});
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['orders'] != null) {
      ...
      json['orders'].forEach((v) {
        orders!.add(new Orders2.fromJson(v));
      });
    }
...
class Orders2 {
  ...
  Orders2.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['car_owner_id'] = this.carOwnerId;
