...
class FilterChangeShipmentStatusScreen extends StatefulWidget{
  int id;
  String status;

  FilterChangeShipmentStatusScreen({required this.id,required this.status});

  @override
  State<StatefulWidget> createState() {
    return _FilterChangeShipmentStatusScreen(id: id,status: status);
  }
}
class _FilterChangeShipmentStatusScreen extends State<FilterChangeShipmentStatusScreen>{
  String status;
  dateGroup? date;
  int id;
  var lang="";
  _FilterChangeShipmentStatusScreen({required this.id,required this.status});
    ...
    return Container(
      ...
      child: TextButton(
        ...
        onPressed: (){
          ...
          updateStatusController.UpdateStatus(context,id,date!.name.toString());
        },
