...
import '../../branches/branches_details/branches_details_screen.dart';
import '../../branches/branches_screen.dart';
import '../delegate_screen.dart';

class AddDelegetDorBranchScreen extends StatefulWidget{
  int branchId;
  AddDelegetDorBranchScreen({required this.branchId});
  @override
  State<StatefulWidget> createState() {
    return _AddDelegetDorBranchScreen(branchId: branchId);
  }
}

class _AddDelegetDorBranchScreen extends State<AddDelegetDorBranchScreen>{
  ...
  int branchId;
  _AddDelegetDorBranchScreen({required this.branchId});
                          ...
                          onPressed: () {
                            Navigator.pushReplacement(context,
                                MaterialPageRoute(builder: (context) {
                                  return BranchesBetailsScreen(branchId: branchId,);
                                }));
  ...
  ValidationAndApisCall() {
    if (addDelegateController.delegate_nameController.text == null ||
      ...
      addDelegateController.choose_branches=branchId;
      addDelegateController.isVisabl.value = true;
      //controller.updateToken();
      addDelegateController.AddDelegateForBranch(context!);
    }
  }
