...
class DeleteDelegateScreen extends StatefulWidget{
  int id;
  var token;

  DeleteDelegateScreen({required this.id,required this.token});

  @override
  State<StatefulWidget> createState() {
    return _DeleteDelegateScreen();
  }
}

class _DeleteDelegateScreen extends State<DeleteDelegateScreen>{
      ...
      child: Directionality(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10,),
            Text("${getLang(context, 'Do_you_want_to_confirm_the_deletion')}",
              ...
              children: [
                Expanded(
                  child: DialogButton(
                    height: 53,
                    onPressed: () => {
                      delegateController.delete(context,widget.token)
                    },
