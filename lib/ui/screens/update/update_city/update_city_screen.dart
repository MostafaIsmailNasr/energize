...
class UpdateCityScreen extends StatefulWidget{
  int id;
  UpdateCityScreen({required this.id});
  @override
  State<StatefulWidget> createState() {
    return _UpdateCityScreen();
  }
}

class _UpdateCityScreen extends State<UpdateCityScreen>{
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                ...
                top: 10,
                child: Center(
                  child: Text("${getLang(context, "update_city")}",
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: TextFormField(
              ...
              validator: (String? validate){
                if(cityController.cityNameController.text.isEmpty){
                  return "${getLang(context, "enter_city_name")}";
                }
                return null;
              },
          ...
          Obx(() => Visibility(
              visible: cityController.isVisable.value,
            ...
            child: TextButton(
              ...
              onPressed: (){
                if(formkey.currentState!.validate()){
                  cityController.isVisable.value=true;
                  cityController.updateCity(context,widget.id);
                }
              },
