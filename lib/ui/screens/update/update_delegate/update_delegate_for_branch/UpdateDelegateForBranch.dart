...
import '../../../menu/branches/branches_details/branches_details_screen.dart';


class UpdateDelegateForBranch extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    return _UpdateDelegateForBranch();
  }
}

class _UpdateDelegateForBranch extends State<UpdateDelegateForBranch>{
  ...
  @override
  void initState() {
    updateDelegateController.getData();
    super.initState();
  }
                      ...
                      appBar: AppBar(
                        leading: IconButton(
                            ...
                            onPressed: () async{
                              ...
                              var id=prefs.getInt('delegateBranchId')!;
                              // ignore: use_build_context_synchronously
                              Navigator.pushReplacement(context,
                                  MaterialPageRoute(builder: (context) {
                                    return BranchesBetailsScreen(branchId: id,);
                                  }));
                            },
  ...
  ValidationAndApisCall() {
    if (updateDelegateController.delegate_nameController.text == null ||
      ...
      updateDelegateController.updateDelegateForBranch(context!);
    }
  }
